...
data_train <- data_train %>% filter(Income != 28.941, Income != 20.089, Income != 92.112, Income != 13.676, Income != 24.050, Income != 27.590, Income != 15.629, Income != 10.363, Income != 30.733, Income != 28.575, Income != 20.150)
...
model_linear_transform_6 <- lm(data = data_2, sqrt(Balance) ~ sqrt(EN*Poly*MLR*Robust) + sqrt(MARS)*sqrt(LASSO)*sqrt(Robust)*sqrt(LOESS) + sqrt(B)*sqrt(Ridge)*sqrt(Root)*sqrt(Robust)) 
...
model_boxcox_6 <- lm(data = data_3, sqrt(Balance) ~ sqrt(EN*Poly*MLR*Robust) + sqrt(MARS)*sqrt(LASSO)*sqrt(Robust)*sqrt(LOESS) + sqrt(B)*sqrt(Ridge)*sqrt(Root)*sqrt(Robust)) 
...
# Fit new model using the Box-Cox transformation
model_linear_transformed_boxcox_6 <- lm(data = data_3, ((sqrt(Balance)^lambda_6 - 1)/lambda_6) ~ sqrt(EN*Poly*MLR*Robust) + sqrt(MARS)*sqrt(LASSO)*sqrt(Robust)*sqrt(LOESS) + sqrt(B)*sqrt(Ridge)*sqrt(Root)*sqrt(Robust)) 
...
model_linear_transform_9 <- lm(data = data_2, sqrt(Balance) ~ sqrt(MLR)*sqrt(Root*Poly) + sqrt(MARS)*sqrt(LASSO)*sqrt(Robust)*sqrt(LOESS) + sqrt(B)*sqrt(Ridge)*sqrt(EN)) 
...
model_boxcox_9 <- lm(data = data_3, sqrt(Balance) ~ sqrt(MLR)*sqrt(Root*Poly) + sqrt(MARS)*sqrt(LASSO)*sqrt(Robust)*sqrt(LOESS) + sqrt(B)*sqrt(Ridge)*sqrt(EN)) 
...
# Fit new model using the Box-Cox transformation
model_linear_transformed_boxcox_9 <- lm(data = data_3, ((sqrt(Balance)^lambda_9 - 1)/lambda_9) ~ sqrt(MLR)*sqrt(Root*Poly) + sqrt(MARS)*sqrt(LASSO)*sqrt(Robust)*sqrt(LOESS) + sqrt(B)*sqrt(Ridge)*sqrt(EN)) 
...
cbind(y_linear_transformed_boxcox_2,y_linear_transformed_boxcox_4, y_linear_transformed_boxcox_6, y_linear_transformed_boxcox_7, y_linear_transformed_boxcox_8, y_linear_transformed_boxcox_9)
cbind(glance(model_linear_transformed_boxcox_2), glance(model_linear_transformed_boxcox_4), glance(model_linear_transformed_boxcox_6), glance(model_linear_transformed_boxcox_7), glance(model_linear_transformed_boxcox_8), glance(model_linear_transformed_boxcox_9))
...
y_2 <- (model_linear_transform_2$fitted.values)^2
y_4 <- (model_linear_transform_4$fitted.values)^2
y_6 <- (model_linear_transform_6$fitted.values)^2
y_7 <- (model_linear_transform_7$fitted.values)^2
y_8 <- (model_linear_transform_8$fitted.values)^2
y_9 <- (model_linear_transform_9$fitted.values)^2


data_4 <- data_2 %>%
  mutate(Y2 = y_2, Y4 = y_4, Y6 = y_6, Y7 = y_7, Y8 = y_8, Y9 = y_9)

data_5 <- data_3 %>%
  mutate(Y2 = y_2, Y4 = y_4, Y6 = y_6, Y7 = y_7, Y8 = y_8, Y9 = y_9)

data_test_modified_5 <- data_test_modified_4 %>%
  mutate(Y2 = y_linear_transform_2, Y4 = y_linear_transform_4, Y6 = y_linear_transform_6, Y7 = y_linear_transform_7, Y8 = y_linear_transform_8, Y9 = y_linear_transform_9)


model_Y <- lm(data = data_4, sqrt(Balance) ~ sqrt(Y2) * sqrt(Y4) * sqrt(Y6) + sqrt(Y7) * sqrt(Y8) * sqrt(Y9)) 
Y <- predict(model_Y, newdata = data_test_modified_5)^2
# View(as_tibble(Y))
# par(mfrow = c(2,2)); plot(model_Y)


model_boxcox_Y <- lm(data = data_5, sqrt(Balance) ~ sqrt(Y2) * sqrt(Y4) * sqrt(Y6) + sqrt(Y7) * sqrt(Y8) * sqrt(Y9)) 
...
# Fit new model using the Box-Cox transformation
model_transformed_boxcox_Y <- lm(data = data_5, ((sqrt(Balance)^lambda_Y - 1)/lambda_Y) ~ sqrt(Y2) * sqrt(Y4) * sqrt(Y6) + sqrt(Y7) * sqrt(Y8) * sqrt(Y9)) 
...
cbind(glance(model_boxcox_Y), glance(model_linear_transformed_boxcox_2), glance(model_linear_transformed_boxcox_4), glance(model_linear_transformed_boxcox_6) , glance(model_linear_transformed_boxcox_7), glance(model_linear_transformed_boxcox_8), glance(model_linear_transformed_boxcox_9))
cbind(y_transformed_boxcox_Y, y_linear_transformed_boxcox_2, y_linear_transformed_boxcox_4, y_linear_transformed_boxcox_6, y_linear_transformed_boxcox_7, y_linear_transformed_boxcox_8, y_linear_transformed_boxcox_9)


cbind(glance(model_Y), glance(model_linear_transform_2), glance(model_linear_transform_4), glance(model_linear_transform_6), glance(model_linear_transform_7), glance(model_linear_transform_8), glance(model_linear_transform_9))
cbind(Y, y_linear_transform_2, y_linear_transform_4, y_linear_transform_6, y_linear_transform_7, y_linear_transform_8, y_linear_transform_9)
